        ...
        >
          <p className="theme--detail--dark">
            <ScrambleText delay={2}>
              Currently building a strong foundation in modern web technologies
              through self-directed learning and hands-on projects. I tackle
              complex coding challenges independently, continuously improving my
              skills in React, Next.js, TailwindCSS, and fullstack application
              development. Dedicated to creating impactful, user-friendly
              applications and contributing to technology that makes people’s
              lives better.
            </ScrambleText>
          </p>
        </motion.div>
